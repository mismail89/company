...
import '../styles/home/cardssec.css'
        ...
        <div className='flex all-card-div'>
            <div className='cards-all'>
                <div className='one-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Structural Engineering</h1>
                </div>
                <div className='two-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Geotechnical Engineering</h1>
                </div>
                <div className='three-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Transportation Engineering</h1>
                </div>
                <div className='four-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Environmental Engineering
</h1>
                </div>
            </div>
            <div className={`cards-all transition-all duration-500 ${display ? 'flex': 'hidden'}`}>
                <div className='five-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Hydraulic Engineering</h1>
                </div>
                <div className='six-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Construction Management</h1>
                </div>
                <div className='seven-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Materials Engineering</h1>
                </div>
                <div className='eight-card smae-card'>
                    <h1 className='text-white text-2xl mt-6 ml-6 font-bold'>Surveying and Geomatics
</h1>
                </div>
            </div>
