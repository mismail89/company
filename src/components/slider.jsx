...
import '../styles/home/slides.css'
import { LiaDatabaseSolid } from "react-icons/lia";
import '../styles/home/careerslider.css'
    ...
    <div className='main-slides-last flex w-full flex-col justify-center items-center relative'>
        ...
        <div className='main-slide flex flex-col justify-center items-center'>
            <div className='flex flex-row justify-between items-center w-full py-2'>
                <h1 className='text-white lg:text-4xl font-extralight'>Our Main Works</h1>
            ...
            <div className='slider-wrapper ease-out duration-500' id='wraper' style={{transform: `translateX(-${curr * 350}px)`}}>
                <div className='each-slide each-seven one-each-slide'>
                    <div className='lower-data-link'>
                        <h1 className=' text-3xl text-white mb-2'>Focuses on designing and analyzing structures such as buildings, bridges, and dams</h1>
                ...
                <div className='each-slide each-second one-each-slide'>
                    ...
                    <div className='lower-data-link'>
                        <h1 className=' text-3xl text-white mb-2'>Deals with soil mechanics, foundation design, and earthworks</h1>
                        <button className='flex flex-row justify-center items-center gap-2 text-white text-lg font-bold'><LiaDatabaseSolid /> Read More</button>
                    </div>
                </div>
                ...
                <div className='each-slide each-last one-each-slide'>
                    ...
                    <div className='lower-data-link'>
                        <h1 className=' text-3xl text-white mb-2'>Involves designing and maintaining transportation systems </h1>
                        <button className='flex flex-row justify-center items-center gap-2 text-white text-lg font-bold'><LiaDatabaseSolid /> Read More</button>
                    </div>
                </div>
                <div className='each-slide each-first one-each-slide'>
                   ...
                   <div className='lower-data-link'>
                       <h1 className=' text-3xl text-white mb-2'>Concerned with water-related infrastructure, including dams, canals, and flood control</h1>
                       <button className='flex flex-row justify-center items-center gap-2 text-white text-lg font-bold'><LiaDatabaseSolid /> Read More</button>
                   </div>
               </div>
               <div className='each-slide each-six one-each-slide'>
                   
                   <div className='lower-data-link'>
                       <h1 className=' text-3xl text-white mb-2'>Addresses environmental issues related to water, air, and land.</h1>
                       <button className='flex flex-row justify-center items-center gap-2 text-white text-lg font-bold'><LiaDatabaseSolid /> Read More</button>
                   </div>
               </div>
